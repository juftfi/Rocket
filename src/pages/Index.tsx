...
const CONTRACT = "0xebd0219f755223589a846eada554b370e3d07777";
      ...
      <header className="sticky top-0 z-50 backdrop-blur-md bg-background/80 border-b border-border">
        <nav className="container mx-auto flex items-center justify-between py-4">
          ...
          <Button asChild size="lg" className="bg-gradient-primary hover:opacity-90 shadow-elegant rounded-full font-bold">
            <a href="https://flap.sh/bnb/0xebd0219f755223589a846eada554b370e3d07777" target="_blank" rel="noopener noreferrer">Launch on flap.sh</a>
          </Button>
        </nav>
      </header>
            ...
            <div className="space-y-8">
              ...
              <div className="flex flex-wrap gap-3">
                <Button asChild size="lg" className="bg-gradient-primary hover:opacity-90 shadow-elegant rounded-full font-bold h-14 px-8 text-base">
                  <a href="https://flap.sh/bnb/0xebd0219f755223589a846eada554b370e3d07777" target="_blank" rel="noopener noreferrer">
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <div className="flex items-center gap-4">
              ...
              <a href="https://flap.sh/bnb/0xebd0219f755223589a846eada554b370e3d07777" target="_blank" rel="noopener noreferrer" className="h-10 w-10 rounded-full bg-background/10 hover:bg-primary transition-smooth flex items-center justify-center">
